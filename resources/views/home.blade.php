  ...
  <main id="main">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
            <img src="{{config('app_url')}}/Frontend/assets/img/about.jpg" class="img-fluid" alt="">
          </div>
    ...
    <section id="features" class="features">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="image col-lg-6" style='background-image: url("{{config('app_url')}}/Frontend/assets/img/features.jpg");' data-aos="fade-right"></div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{config('app_url')}}/Frontend/assets/img/testimonials/testimonials-1.jpg" class="testimonial-img" alt="">
                <h3>Saul Goodman</h3>
                <h4>Ceo &amp; Founder</h4>
                <p>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{config('app_url')}}/Frontend/assets/img/testimonials/testimonials-2.jpg" class="testimonial-img" alt="">
                <h3>Sara Wilsson</h3>
                <h4>Designer</h4>
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{config('app_url')}}/Frontend/assets/img/testimonials/testimonials-3.jpg" class="testimonial-img" alt="">
                <h3>Jena Karlis</h3>
                <h4>Store Owner</h4>
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{config('app_url')}}/Frontend/assets/img/testimonials/testimonials-4.jpg" class="testimonial-img" alt="">
                <h3>Matt Brandon</h3>
                <h4>Freelancer</h4>
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{config('app_url')}}/Frontend/assets/img/testimonials/testimonials-5.jpg" class="testimonial-img" alt="">
                <h3>John Larson</h3>
                <h4>Entrepreneur</h4>
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="100">
              <div class="member-img">
                <img src="{{ asset('uploads/photos/'.$item->image) }}" style=" width:230px;height:230px; border-radius:100%;" class="img-fluid" alt="">
                <div class="social">
