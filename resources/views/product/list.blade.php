...
<input type="hidden" name="q" value="{{!empty(Request::get('q')) ? Request::get('q') : ''}}">
           ...
           <input type="text" name="old_sub_category_id" value="{{!empty($getSubCategory) ? $getSubCategory->id : ''}}" onChange="FilterForm()">
              ...
              <div class="collapse show" id="widget-3">
                <div class="widget-body">
                  <div class="filter-colors">
                    ...
                    <a href="javascript:;" id="{{$f_color->id}}" class="ChangeColor" data-val="0"  style="background: {{ $f_color->code }} ;"><span
