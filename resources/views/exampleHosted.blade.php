    ...
    <div class="row">
        <div class="col-md-4 order-md-2 mb-4">
            ...
            <ul class="list-group mb-3">
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                        <h6 class="my-0">{{$getItem->title}}</h6>
                        <small class="text-muted">{{$getItem->short_description}}</small>
                    </div>
                    <span class="text-muted">{{$getItem->price}}</span>
                </li>
                
                <li class="list-group-item d-flex justify-content-between">
                    <span>Total (BDT)</span>
                    <strong>{{$getItem->price*$count}} TK</strong>
                </li>
            </ul>
        </div>
        <div class="col-md-8 order-md-1">
            ...
            <form action="{{ url('/pay') }}" method="POST" class="needs-validation">
                ...
                <input type="hidden" value="{{ $getItem->price*$count }}" name="amount" />
                <div class="row">
