              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control"  name="password"
                   ...
                   <p>If you want to change password then please add</p>
                </div>
                <div class="form-group">
                  <label >Status</label>
                  <select class="form-control" name="status">
                    <option {{($getRecord->email == 0)? 'selected' : '' }} value="0">Active</option>
                    <option {{($getRecord->email == 1)? 'selected' : '' }} value="1">Inactive</option>
                  </select>
